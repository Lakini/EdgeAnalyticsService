...
public class HumiditySensorService implements SensorEventListener {
    ...
    public static HumiditySensorService getInstance(Context context) {
        if(mHumiditySensorServiceInstance == null) {
            mHumiditySensorServiceInstance = new HumiditySensorService(context);
        }
    ...
    public void onSensorChanged(final SensorEvent event) {
        ...
        Log.d("edge:Humidity", String.valueOf(mHumidityValue));
    }
